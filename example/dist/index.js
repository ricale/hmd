...
var resizeResponsive = function resizeResponsive() {
  var $window = (0, _jquery2.default)(window);
  var $source = (0, _jquery2.default)('#source');

  var boxWidth = $window.width() / 2 - 10;
  var boxHeight = $window.height() - $source.position().top - 15;

  (0, _jquery2.default)('#source').css('width', boxWidth).css('height', boxHeight);
  (0, _jquery2.default)('#target').css('width', boxWidth).css('height', boxHeight);
};

_index2.default.run(document.getElementById('source'), document.getElementById('target'));
resizeResponsive();

(0, _jquery2.default)(window).resize(resizeResponsive);
