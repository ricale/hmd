...
이 문서는 hmd의 [git 저장소의 README][git] 와 [comfycastle blog에 작성된 글][blog]로 볼 수 있다.
...
\> 를 사용한다. > 뒤에 반드시 공백이 하나 이상 있어야 한다. 아니라면 인용 문법이 아닌 > 문자로 인식한다. (다른 마크다운 에디터 중에는 내용 공백이 모두 없으면 >만 써도 인용 문법으로 인식하는 것도 있다.)
